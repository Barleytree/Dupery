...
namespace Dupery.Menu
{
    public class PoolEditorScreen : DuperyScreen
    {
        ...
        {
            Sprite headSprite = DuperyPatches.AccessoryManager.GetAcessorySprite(Db.Get().AccessorySlots.HeadShape, personality);
            ...
            Sprite hairSprite = DuperyPatches.AccessoryManager.GetAcessorySprite(Db.Get().AccessorySlots.Hair, personality);
